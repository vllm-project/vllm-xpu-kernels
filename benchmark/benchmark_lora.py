...
class BenchmarkTensors:
    ...
    def convert_to_sgmv_benchmark_tensors(self):
        ...
        assert torch.sum(seq_lens) == torch.sum(self.seq_lens), \
            (f"dont match - new {torch.sum(seq_lens)}"
...
Benchmark LoRA kernels:
    ...
    model_bench example:
        python3 benchmark/benchmark_lora.py model_bench --models meta-llama/Llama-3-8b  --arg-pool-size 32 --batch-sizes 1 16 32 --dtype torch.float16  --lora-ranks 16 --num-loras 1 4 --op-types bgmv_shrink bgmv_expand bgmv_expand_slice --seq-lengths 1 --sort-by-lora-id 1

    range_bench example:
        python3 benchmark/benchmark_lora.py range_bench  --arg-pool-size 32 --batch-sizes 1 16 32 --dtype torch.float16   --num-loras 1 4 --op-types bgmv_shrink bgmv_expand bgmv_expand_slice --seq-lengths 1 16 --sort-by-lora-id 1 --hidden-sizes-start 1024 --hidden-sizes-end 4096 --hidden-sizes-increment 1024 --lora-ranks-start 8 --lora-ranks-end 24 --lora-ranks-increment 8 
            """,  # noqa: E501
