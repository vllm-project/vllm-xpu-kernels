...
# =============================================================================
# This function generates kernel source files for all combinations of:
# - Policy types (q_group_size × head_size)
# - Boolean flags (Causal, Local, Sink)
#
...
#
# Usage:
#   paged_decode_configure(paged_decode_kernel)
#
# Parameters:
#   FILENAME_SUFFIX - Base name for generated .cpp files (without extension)
#
# Output:
#   GEN_KERNEL_SRCS - List of generated source file paths
#   GEN_KERNEL_SRCS_LENGTH - Number of generated files
#   ATTN_KERNEL_SRCS_GEN - Updated global list with appended sources
# =============================================================================
...
function(paged_decode_configure FILENAME_SUFFIX)
  ...
  # =============================================================================
  # Maps (q_group_size, head_size) pairs to policy type names
  # These must match the policies defined in paged_decode_policy.hpp
  ...
  message(STATUS "Generated ${FILENAME_SUFFIX} sources: ${GEN_KERNEL_SRCS_LENGTH} files")
