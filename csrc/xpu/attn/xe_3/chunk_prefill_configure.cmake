# =============================================================================
# Chunk Prefill Kernel Configuration (XE3)
# =============================================================================
...
# =============================================================================
function(_chunk_prefill_parse_config_xe3 CONFIG_FILE OUT_TUPLES OUT_IS_FULL)
  set(_tuples)
  set(_is_full FALSE)
...
function(fmha_forward_configure FILENAME_SUFFIX)
  ...
  # =============================================================================
  message(
    STATUS "XE3 Chunk prefill kernel config: ${VLLM_CHUNK_PREFILL_CONFIG}")
  _chunk_prefill_parse_config_xe3("${VLLM_CHUNK_PREFILL_CONFIG}" CONFIG_TUPLES
                                  CONFIG_IS_FULL)
  ...
  if(CONFIG_IS_FULL)
    # Full mode: generate all valid combinations
  ...
  message(
    STATUS
      "XE3 Generated ${FILENAME_SUFFIX} kernel sources: ${GEN_KERNEL_SRCS_LENGTH} files "
