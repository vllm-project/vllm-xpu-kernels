# =============================================================================
# Paged Decode Kernel Configuration (XE3)
# =============================================================================
...
# =============================================================================
function(_paged_decode_parse_config_xe3 CONFIG_FILE OUT_TUPLES OUT_IS_FULL)
  set(_tuples)
  set(_is_full FALSE)
...
function(paged_decode_configure FILENAME_SUFFIX)
  ...
  # =============================================================================
  message(STATUS "XE3 Paged decode kernel config: ${VLLM_PAGED_DECODE_CONFIG}")
  _paged_decode_parse_config_xe3("${VLLM_PAGED_DECODE_CONFIG}" CONFIG_TUPLES
                                 CONFIG_IS_FULL)
  ...
  if(CONFIG_IS_FULL)
    # Full mode: generate all combinations
    ...
    foreach(_entry ${CONFIG_TUPLES})
      ...
      # Skip entries that don't match XE3's supported configuration space
      if(NOT "${policy_${_qgroup}_${_headsize}_${_pagesize}}" STREQUAL "")
        ...
        message(
          STATUS
            "XE3 paged decode: skipping unsupported config entry: ${_entry}")
      endif()
    endforeach()
  endif()
  ...
  message(
    STATUS
      "XE3 Generated ${FILENAME_SUFFIX} sources: ${GEN_KERNEL_SRCS_LENGTH} files "
