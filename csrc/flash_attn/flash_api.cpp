...
std::vector<at::Tensor> mha_varlen_fwd(
  ...
  TORCH_CHECK(block_table_.dtype() == torch::kInt32, "page_table must have dtype torch.int32");
  TORCH_CHECK(block_table_.stride(-1) == 1, "page_table must have contiguous last dimension");
