...
class per_token_group_quant_8bit_kernel {
 ...
 public:
  ...
  void operator() [[sycl::reqd_sub_group_size(32)]] (sycl::nd_item<1> item) const {
    ...
    if (scale_ue8m0) {
      y_s = sycl::exp2(sycl::ceil(sycl::log2(sycl::fmax(sycl::fabs(y_s), 1e-10f))));
    }
            ...
            [&] {
              ...
              queue
                  .submit([&](sycl::handler& cgh) {
                    auto kernel =
                        vllm::per_token_group_quant_8bit_kernel<
                            scalar_t,
                            fp8_t>(
