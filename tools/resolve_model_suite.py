...
def _load_mappings(
    ...
    kernel_module = importlib.import_module("tests.suites.kernel_test_map")
    model_module = importlib.import_module("tests.suites.model_kernel_map")
    return kernel_module.KERNEL_TO_TESTS, model_module.MODEL_TO_KERNELS


KERNEL_TO_TESTS, MODEL_TO_KERNELS = _load_mappings()
