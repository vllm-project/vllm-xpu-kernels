...
def flash_attn_varlen_func(
    ...
    if fa_version == 2:
        ...
        out, softmax_lse, tmp_out, exp_sums, max_logits = torch.ops._vllm_fa2_C.varlen_fwd(
            q,
            k,
            v,
            out,
    ...
    return (out, softmax_lse) if return_softmax_lse else (out, tmp_out, exp_sums, max_logits)
